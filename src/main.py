...
class Snake():
    def __init__(self, mainCanvas):
        ...
        for x, y in self.coordinates:
            square = mainCanvas.create_rectangle(x, y, x + SPACE_SIZE, y + SPACE_SIZE, fill=SNAKE_COLOR, tag="snake")
...
class Food:
    def __init__(self, mainCanvas):
        ...
        mainCanvas.create_oval(x, y, x+SPACE_SIZE, y+SPACE_SIZE, fill= FOOD_COLOR, tag="food")

def next_turn(snake, food, mainCanvas):
